...
import stylesCss from 'themes/myapptopmenu/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_myapptopmenu_componentCss']) {
    
    document['_vaadintheme_myapptopmenu_componentCss'] = true;
  }
